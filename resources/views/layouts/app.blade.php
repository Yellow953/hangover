...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top" style="background: dimgrey;">
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm m-0">
            <div class="container">
                <i class="fa fa-play fa-code" style="margin-right: 10px; "></i>
                <a class="navbar-brand" href="{{ url('/') }}">Hangover</a>
