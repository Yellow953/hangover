        ...
        <div class="container-fluid  dashboard-content">
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <div class="page-header">
                        <h2 class="pageheader-title">User Data Table</h2>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td><a href="/deleteUser/{{$user->id}}" class="btn btn-danger" style="border-radius: 50px">Delete</a></td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="row">
                        <h2 class="text-center">Create new User : <a href="/register" class="btn btn-primary" style="border-radius: 50px">Create</a></h2>
                    </div>
                </div>
            </div>
        </div>
